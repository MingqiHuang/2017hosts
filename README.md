...
<p>2.部分省份运营商已知可能无法正常使用本处hosts（譬如YouTube遭遇基于SNI辨识的TLS限速从而导致视频速度慢，广电网根本连不上等等），这个是你我不能左右的，我也没办法。</p>
<br />
<h3>常见问题解答：</h3>
<p>1.我steam 101 103咋办？</p>
<p>答：打开hosts，自行搜索steam段，删掉这段所有条目再试试就行了。</p>
<p>2.为啥我YouTube这么慢？</p>
...
<p>3.看视频的话如果直连不行，那还是用翻墙软件吧。</p>
 <p>4.为什么我在手机上用不了这个hosts？</p>
 <p>答：请自行使用notepad转换文档格式为unix格式。</p>
 <p>5.为什么我在win10上替换hosts以后，要显示好长一段时间解析主机？</p>
 <p>这是一个RPC服务导致的，暂时还未摸清楚什么原因。</p>
 <p>6.hosts能起到网络加速的作用吗？</p>
